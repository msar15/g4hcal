...
#include </sphenix/user/sar/sphenix/coresoftware/tmp/install/include/g4ohcal/PHG4OHCalSubsystem.h>
                 ...
                 const int crossings)
{
  ...
  PHG4OHCalSubsystem *hcal = new PHG4OHCalSubsystem("HCALOUT");
  ...
  hcal->set_string_param("GDMPath", "/sphenix/user/sar/sphenix/macros/detectors/sPHENIX/gdml/OuterHCalAbsorberTiles.gdml");
