...
#include </sphenix/user/sar/sphenix/coresoftware/tmp/install/include/g4ihcal/PHG4IHCalSubsystem.h>
                 ...
                 const int crossings)
{
  ...
  // all sizes are in cm!
  PHG4IHCalSubsystem *hcal = new PHG4IHCalSubsystem("HCALIN");
  ...
  // hcal->set_string_param("material", "SS310");
  hcal->set_string_param("GDMPath", "/sphenix/user/sar/sphenix/macros/detectors/sPHENIX/gdml/InnerHCalAbsorberTiles.gdml");
